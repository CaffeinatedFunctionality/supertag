module Supertag
  module Hashtaggable
    ...
    included do
      has_many :hashtaggings, as: :hashtaggable,  class_name: "Supertag::Hashtagging", dependent: :destroy
      has_many :hashtags, through: :hashtaggings, class_name: "Supertag::Hashtag"
